...
export default function UnderConstruction() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden  flex items-center justify-center px-6 py-12">
      <div className="absolute top-[-120px] left-[-120px] w-[320px] h-[320px] rounded-md  blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-2xl border border-(--border) bg-(--glass) backdrop-blur-xl shadow-(--shadow-lg) rounded-sm p-10 text-center">
        ...
        <p className="mt-5 text-(--text-secondary) text-base md:text-lg leading-relaxed max-w-xl mx-auto">
          We are currently building this section to provide you with secure restore guides and resources. Check back soon!
        </p>
